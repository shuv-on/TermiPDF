        ...
        rows = [
            ...
            ("Edit", [
                ...
                ("gen npdf p-1,2,3 &lt;out.pdf&gt;",
                 "Generate a new PDF from current pages"),
                ("image2pdf | img2pdf &lt;img1&gt; [img2 ...]",
            ...
            ("Tools", [
                ("qr \"text\" [--page n --x n --y n --size n]",
                 "Open QR-share popup (preview / share dialog)"),
                ("stamp-capture &lt;name&gt;", "Save current selection as a stamp (Phase 4 stub)"),
                ("stamp &lt;name&gt; --page n --x … --y …",
                 "Paste a saved stamp (Phase 4 stub)"),
                ("screenshot page",  "Save current page as PNG (also clipboard)"),
                ("screenshot region", "Use the OS-native screenshot tool"),
            ]),
            ("UI", [
                ("theme dark | light",         "Switch theme"),
                ("fullscreen",                 "Toggle fullscreen (F11)"),
                ("view single | continuous",   "Switch the active tab between single-page and continuous scroll"),
